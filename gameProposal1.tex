...
\begin{itemize}
\item Noun Marker Panel: Select \textit{si}, \textit{ki}, \textit{sa} markers for the entities.
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.7\textwidth]{diagrams/act.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.7\textwidth]{diagrams/dfd0.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.7\textwidth]{diagrams/dfd1.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.7\textwidth]{diagrams/dfd2a.png}
...
\item
  RelationComponent: loyaltym hostility
\item
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.7\textwidth]{diagrams/elgantt.png}
